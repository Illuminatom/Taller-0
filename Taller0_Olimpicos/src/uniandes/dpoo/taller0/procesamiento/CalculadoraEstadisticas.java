...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el nombre del pais al que pertenece cierto atleta
	 * @param nombreA El nombre del atleta a consultar
	 * @return Una cadena de caracteres que es el nombre del pais al que dicho atleta
	 *         representa
	 */
	public String paisDeAtleta(String nombreA)
	{
		String resultado = new String(); 
		Atleta elAtleta = buscarAtleta(nombreA);
		if (elAtleta != null)
		{

...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este metodo le pide al usuario el nombre de un atleta para retornar el pais al que 
	 * representa
	 */
	private void ejecutarpaisDeAtleta()
	{
		System.out.println("\n" + "Pais al que representa un atleta" + "\n");
		String nombreA = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.paisDeAtleta(nombreA);
		if (pais != null)
		{
			System.out.println("El pais al que representa " + nombreA + " es " + pais);
		}
		else
		{
